...
export const CategoryNav = ({
	...
	return (
		<div className="sticky top-0 bg-white z-40 shadow-md transition-shadow w-full">
			<div className="container mx-auto px-4 h-16 hidden md:flex items-center justify-start">
			<NavigationMenu viewport={false}>
				<NavigationMenuList>
					<NavigationMenuItem>
						<NavigationMenuTrigger className="hover:bg-white focus:bg-white data-[state=open]:focus:bg-white data-[state=open]:hover:bg-white">Nội Thất Phòng Khách</NavigationMenuTrigger>
						<NavigationMenuContent>
					...
					<NavigationMenuItem>
						<NavigationMenuTrigger className="hover:bg-white focus:bg-white data-[state=open]:focus:bg-white data-[state=open]:hover:bg-white">Bàn Ghế Gỗ</NavigationMenuTrigger>
						<NavigationMenuContent>
					...
					<NavigationMenuItem>
						<NavigationMenuLink asChild className="hover:bg-white focus:bg-white data-[state=open]:focus:bg-white data-[state=open]:hover:bg-white">
							<Link href="/category/ke-tivi">
								<div className="font-medium">Kệ Tivi</div>
							</Link>
						</NavigationMenuLink>

					</NavigationMenuItem>
					<NavigationMenuItem>
						<NavigationMenuTrigger className="hover:bg-white focus:bg-white data-[state=open]:focus:bg-white data-[state=open]:hover:bg-white">Đồ Thờ</NavigationMenuTrigger>
						<NavigationMenuContent>
